        ...
        for (int32_t sl = sl_start; sl < sl_end; sl += kThreadGroupSize) {
            ...
            for (int32_t j = 0; j < kThreadGroupSize && sl + j < sl_end; j += 8) {
                ...
                if (threadIdx.x * VEC_WIDTH < D) {
                    ...
                    Vec4TAcc<grad_t> grad_out_vec0 = Vec4TAcc<grad_t>();
                    Vec4TAcc<grad_t> grad_out_vec1 = Vec4TAcc<grad_t>();
                    Vec4TAcc<grad_t> grad_out_vec2 = Vec4TAcc<grad_t>();
                    Vec4TAcc<grad_t> grad_out_vec3 = Vec4TAcc<grad_t>();
                    Vec4TAcc<grad_t> grad_out_vec4 = Vec4TAcc<grad_t>();
                    Vec4TAcc<grad_t> grad_out_vec5 = Vec4TAcc<grad_t>();
                    Vec4TAcc<grad_t> grad_out_vec6 = Vec4TAcc<grad_t>();
                    Vec4TAcc<grad_t> grad_out_vec7 = Vec4TAcc<grad_t>();
