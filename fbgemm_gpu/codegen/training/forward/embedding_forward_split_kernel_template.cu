...
{%- macro template_instantiation(
    ...
    nobag_exp=False)
%}
{%- if nobag_exp and nobag and not dense and not ssd and not is_gwd_kernel and not vbe and not is_index_select %}
